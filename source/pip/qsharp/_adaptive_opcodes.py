...
FLAG_WIDE_IMM = 1 << 18  # wide immediate (reserved for future i64)
FLAG_FLOAT = 1 << 19  # operation uses float semantics
FLAG_64BIT = 1 << 21  # reserved for future i64 support
...
# ── Sentinel values ──────────────────────────────────────────────────────────
DYN_QUBIT_SENTINEL = 0xFFFFFFFF  # "use static qubit from quantum op pool"
