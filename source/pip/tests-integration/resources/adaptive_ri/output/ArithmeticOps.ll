...
block_1:
  br label %block_2
block_2:
  %var_39 = phi i64 [10, %block_0], [8, %block_1]
  %var_38 = phi i64 [0, %block_0], [5, %block_1]
  %var_37 = phi i64 [0, %block_0], [1, %block_1]
  %var_36 = phi i64 [1, %block_0], [3, %block_1]
...
block_3:
  ...
  %var_14 = add i64 %var_38, 5
  %var_15 = sub i64 %var_39, 2
  %var_16 = mul i64 %var_36, 3
  br label %block_4
block_4:
  ...
  %var_40 = phi i64 [%var_36, %block_2], [%var_16, %block_3]
  %var_17 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 2 to %Result*))
  br i1 %var_17, label %block_5, label %block_6
block_5:
  %var_19 = add i64 %var_41, 1
  %var_20 = add i64 %var_42, 5
  %var_21 = sub i64 %var_43, 2
  %var_22 = mul i64 %var_40, 3
  br label %block_6
block_6:
  ...
  %var_44 = phi i64 [%var_40, %block_4], [%var_22, %block_5]
  %var_23 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 3 to %Result*))
  br i1 %var_23, label %block_7, label %block_8
block_7:
  %var_25 = add i64 %var_45, 1
  %var_26 = add i64 %var_46, 5
  %var_27 = sub i64 %var_47, 2
  %var_28 = mul i64 %var_44, 3
  br label %block_8
block_8:
  ...
  %var_48 = phi i64 [%var_44, %block_6], [%var_28, %block_7]
  %var_29 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 4 to %Result*))
  br i1 %var_29, label %block_9, label %block_10
block_9:
  %var_31 = add i64 %var_49, 1
  %var_32 = add i64 %var_50, 5
  %var_33 = sub i64 %var_51, 2
  %var_34 = mul i64 %var_48, 3
  br label %block_10
block_10:
  ...
  %var_52 = phi i64 [%var_48, %block_8], [%var_34, %block_9]
  ...
  call void @__quantum__rt__int_record_output(i64 %var_52, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @4, i64 0, i64 0))
  ret i64 0
}
