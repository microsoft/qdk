...
> Structural reference for the `circuit-vis` circuit editor. Captures the
> layering the code follows so contributors can navigate it without
> reverse-engineering it from imports.
