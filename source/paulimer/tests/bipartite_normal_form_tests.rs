use paulimer::{bipartite_normal_form, outcome_complete_simulation::OutcomeCompleteSimulation, Simulation, UnitaryOp};
...
fn bipartite_normal_form_test() {
    {
        ...
        let (_, _, _, _) = bipartite_normal_form::bipartite_normal_form(sim.clifford(), num_bell_pairs);
    }
}
