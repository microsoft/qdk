...
fn r_x_yields_expected_qir() {
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              call void @__quantum__rt__initialize(ptr null)
              call void @__quantum__qis__rx__body(double 0.25, ptr inttoptr (i64 0 to ptr))
              call void @__quantum__rt__array_record_output(i64 0, ptr null)
              ret i64 0
            }
...
fn r_y_yields_expected_qir() {
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              call void @__quantum__rt__initialize(ptr null)
              call void @__quantum__qis__ry__body(double 0.25, ptr inttoptr (i64 0 to ptr))
              call void @__quantum__rt__array_record_output(i64 0, ptr null)
              ret i64 0
            }
...
fn r_z_yields_expected_qir() {
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              call void @__quantum__rt__initialize(ptr null)
              call void @__quantum__qis__rz__body(double 0.25, ptr inttoptr (i64 0 to ptr))
              call void @__quantum__rt__array_record_output(i64 0, ptr null)
              ret i64 0
            }
...
fn r_x_broadcasts_over_targets() {
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              call void @__quantum__rt__initialize(ptr null)
              call void @__quantum__qis__rx__body(double 0.125, ptr inttoptr (i64 0 to ptr))
              call void @__quantum__qis__rx__body(double 0.125, ptr inttoptr (i64 1 to ptr))
              call void @__quantum__qis__rx__body(double 0.125, ptr inttoptr (i64 2 to ptr))
              call void @__quantum__rt__array_record_output(i64 0, ptr null)
              ret i64 0
            }
    ...
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              ...
              call void @__quantum__qis__ry__body(double 0.1, ptr inttoptr (i64 0 to ptr))
...
fn r_xx_yields_expected_qir() {
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              call void @__quantum__rt__initialize(ptr null)
              call void @__quantum__qis__rxx__body(double 0.25, ptr inttoptr (i64 0 to ptr), ptr inttoptr (i64 1 to ptr))
              call void @__quantum__rt__array_record_output(i64 0, ptr null)
              ret i64 0
            }
...
fn r_yy_yields_expected_qir() {
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              call void @__quantum__rt__initialize(ptr null)
              call void @__quantum__qis__ryy__body(double 0.25, ptr inttoptr (i64 0 to ptr), ptr inttoptr (i64 1 to ptr))
              call void @__quantum__rt__array_record_output(i64 0, ptr null)
              ret i64 0
            }
...
fn r_zz_yields_expected_qir() {
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              call void @__quantum__rt__initialize(ptr null)
              call void @__quantum__qis__rzz__body(double 0.25, ptr inttoptr (i64 0 to ptr), ptr inttoptr (i64 1 to ptr))
              call void @__quantum__rt__array_record_output(i64 0, ptr null)
              ret i64 0
            }
    ...
    check(
        ...
        &expect![[r#"
            define i64 @ENTRYPOINT__main() #0 {
              call void @__quantum__rt__initialize(ptr null)
              call void @__quantum__qis__rzz__body(double 0.25, ptr inttoptr (i64 0 to ptr), ptr inttoptr (i64 1 to ptr))
              call void @__quantum__qis__rzz__body(double 0.25, ptr inttoptr (i64 2 to ptr), ptr inttoptr (i64 3 to ptr))
              call void @__quantum__rt__array_record_output(i64 0, ptr null)
              ret i64 0
            }
