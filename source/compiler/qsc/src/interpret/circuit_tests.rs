...
fn if_else() {
    ...
    expect![[r#"
        q_0    ─ [[ ────────── [Main] ─────────── H ────── M ───── ]] ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
                      ═══════════ ● ═══════════       ════ ● ══════════════════════════════════════════════════════ ● ══════════════════════════════════════════════════════════════════════════════════
        q_1    ─ [[ ──── [check (c_0 = |1〉)] ─── [[ ─── [true] ─── [[ ─── [Main] ──── X ─── ]] ─── ]] ─── [[ ─── [false] ── [[ ─── [Main] ──── Y ─── ]] ─── ]] ─── ]] ─── [[ ─── [Main] ──── M ─── ]] ──
                                                                                                                                                                                             ╘══════════
    "#]]
    .assert_eq(&circ.to_string());
}
...
fn sequential_ifs() {
    ...
    expect![[r#"
        ...
        q_1    ─ [[ ─── [Main] ──── H ──── M ─── ]] ─────────────────────┼────────────────────────┼────────────────────────────────────────────────────────┼────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
                                           ╘═════════════════════════════╪════════════════════════╪════════════════════════════════════════════════════════╪═════════════════════════════════════════════════════════════════════ ● ══════════════════════ ● ══════════════════════════════════════════════════════ ● ══════════════════════════════════════════════════════════════════════════════════
        q_2    ──────────────────────────────────────── [[ ──── [check (c_0 = |1〉)] ─── [[ ─── [true] ─── [[ ─── [Main] ──── X ─── ]] ─── ]] ─── [[ ─── [false] ── [[ ─── [Main] ──── Z ─── ]] ─── ]] ─── ]] ─── [[ ──── [check (c_1 = |1〉)] ─── [[ ─── [true] ─── [[ ─── [Main] ──── X ─── ]] ─── ]] ─── [[ ─── [false] ── [[ ─── [Main] ──── Y ─── ]] ─── ]] ─── ]] ─── [[ ─── [Main] ──── M ─── ]] ──
                                                                                                                                                                                                                                                                                                                                                                                             ╘══════════
    "#]]
    .assert_eq(&circ.to_string());
}
...
fn branch_on_dynamic_bool() {
    ...
    expect![[r#"
        q_0    ─ [[ ────────────── [Main] ─────────────── H ────── M ───── ]] ─────────────────────────────────────────────────────────────────────────
                      ═══════════════ ● ═══════════════       ════ ● ══════════════════════════════════════════════════════════════════════════════════
        q_1    ─ [[ ─── [check (function of: (c_0))] ─── [[ ─── [true] ─── [[ ─── [Main] ──── X ─── ]] ─── ]] ─── ]] ─── [[ ─── [Main] ──── M ─── ]] ──
                                                                                                                                            ╘══════════
    "#]]
    .assert_eq(&circ.to_string());
}
