...
fn for_loop_in_function_call() {
    ...
    expect![[r#"
        q_0@test.qs:4:20 ── ┌ ─── [Main] ─── X@test.qs:6:24 ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─── ]] ──
                            │
        q_1@test.qs:11:20 ── └ ───────────────────── [ ───────── [Foo] ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── ]] ────────────────────────────────────────────────────────────────────────────────────────────────── ]] ──
    "#]]
    .assert_eq(&circ);
}
...
fn loop_and_scope() {
    ...
    expect![[r#"
        q_0@test.qs:3:16 ── ┌ ─── [Main] ──── ┌ ─── [PrepareSomething] ─── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── ]] ──── ┌ ─── [DoSomethingElse] ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── ]] ──── ┌ ─── [DoSomethingDifferent] ─── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── ]] ──── |0〉@test.qs:9:16 ──── ]] ──
                            │                 │                                                                         │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                   │                                                                       │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                   │                                                                             │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │
        q_1@test.qs:3:16 ── └ ─────────────── └ ──────────────────────────────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ──────────────────────────────────────── X@test.qs:16:20 ── ]] ──── └ ──────────────────────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── H@test.qs:22:20 ── X@test.qs:24:20 ───────── ● ───────── ]] ──── └ ──────────────────────────────────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ──────────────────────────────────────── X@test.qs:33:20 ── ]] ──── |0〉@test.qs:9:16 ──── ]] ──
    "#]]
    .assert_eq(&circ);
}
