...
fn for_loop_in_function_call() {
    // TODO: I feel like this could be left-justified better
    let circ = circuit(
        r"
            namespace Test {
                @EntryPoint()
    ...
    expect![[r#"
        ...
        q_0@test.qs:4:20 ───┼──── X@test.qs:6:24 ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─────┼───
                            │                                                                                                                                                                                                                                                 │
                                         ┌─────────       [Foo]                                                                                                      ───┐
        q_1@test.qs:11:20 ────────────────┼────────── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ────┼─────────────────────────────────────────────────────────────────────────────────────────────────────────
                                         └                                                                                                                              ┘
                            └                                                                                                                                                                                                                                                 ┘
    "#]]
    .assert_eq(&circ);
...
fn loop_and_scope() {
    ...
    expect![[r#"
                            ┌───  [Main]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ───┐
                            │        ┌─────  [PrepareSomething]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ───┐      ┌───  [DoSomethingElse]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ───┐      ┌───  [DoSomethingDifferent]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ───┐                             │
        q_0@test.qs:3:16 ───┼────────┼──────── H@test.qs:14:20 ──── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────── H@test.qs:14:20 ── X@test.qs:15:20 ───────── ● ───────────┼──────┼───── X@test.qs:23:20 ────────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ── X@test.qs:23:20 ───────────────────── X@test.qs:25:20 ────┼──────┼──────── H@test.qs:31:20 ────── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────── H@test.qs:31:20 ── Z@test.qs:32:20 ───────── ● ───────────┼───── |0〉@test.qs:9:16 ──────┼───
                            │        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │            │      │                                                    │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │            │      │                                                          │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │                                                        │            │                             │
...
fn operation_with_qubit_arrays() {
    // TODO: why do all the qubits have gaps between them?
    let circ = circuit(
        r"
        namespace Test {
            @EntryPoint()
...
fn aasdfasdf() {
    ...
    expect![[r#"
                            ┌───           [Main]            ───┐
        q_0@test.qs:6:20 ───┼──── Rxx(1.0000)@test.qs:9:20 ─────┼───
                            └                                   ┘
        q_1@test.qs:7:20 ─────────────────────┆─────────────────────
                            ┌───           [Main]            ───┐
        q_2@test.qs:8:20 ───┼──── Rxx(1.0000)@test.qs:9:20 ─────┼───
                            └                                   ┘
    "#]]
    .assert_eq(&circ);
}
