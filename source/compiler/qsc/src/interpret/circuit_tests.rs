...
fn classical_for_loop() {
    ...
    expect![[r#"
        Eval:
        q_0@test.qs:4:20 ────── [[ ──────── [Main@test.qs:3:16] ─────── [[ ──────── [X(×6)@test.qs:6:24] ─── X@test.qs:6:24 ──────── [[ ──────── [X(×5)@test.qs:6:24] ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ──────── ]] ───────────── ]] ───────────── ]] ───────
...
fn for_loop_in_function_call() {
    ...
    expect![[r#"
        ...
        q_0@test.qs:4:20 ─────── [[ ───────── [Main@test.qs:3:16] ──────── [[ ───────── [X(×6)@test.qs:6:24] ─── X@test.qs:6:24 ───────────── [[ ───────────── [X(×5)@test.qs:6:24] ─── X@test.qs:6:24 ─────── X@test.qs:6:24 ─────── X@test.qs:6:24 ─── X@test.qs:6:24 ─── X@test.qs:6:24 ───────── ]] ─────────────── ]] ──────────────────────────────────────────────────────────────────────── ]] ────────
                                                         ┆
        q_1@test.qs:11:20 ─────── [[ ───────── [Main@test.qs:3:16] ──────── [[ ────────── [Foo@test.qs:10:16] ───────── [[ ────────── [X(×6)@test.qs:13:24] ────── X@test.qs:13:24 ─────────── [[ ────────── [X(×5)@test.qs:13:24] ─── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ── X@test.qs:13:24 ──────── ]] ─────────────── ]] ─────────────── ]] ─────────────── ]] ────────
...
fn two_qubit_reuse() {
    ...
    expect![[r#"
        Eval:
        q_0@test.qs:4:36, test.qs:11:36 ────────────── [[ ───────────────────── [Main@test.qs:2:12] ────────────── X@test.qs:5:20 ──────────────────────── ● ─────────────────────── M@test.qs:7:20 ──────────────── |0〉@test.qs:7:20 ──────────────── Y@test.qs:12:20 ─────────────────────── ● ─────────────────────── M@test.qs:14:20 ─────────────── |0〉@test.qs:14:20 ───────────────────── ]] ───────────────
                                         ══════════════ [[ ═════════════════════ [Main@test.qs:2:12] ══════                                                 │                                ╘══════════════════════════════════════════════════════════════════════════════════════════════════╪════════════════════════════════╪═══════════════════════════════════════════════════════════════ ]] ═══════════════
                                         ══════════════ [[ ═════════════════════ [Main@test.qs:2:12] ══════                                                 │                                                                                                                                   │                                ╘═══════════════════════════════════════════════════════════════ ]] ═══════════════
        q_1@test.qs:4:45, test.qs:11:45 ────────────── [[ ───────────────────── [Main@test.qs:2:12] ─────────────────────────────────────────────── X@test.qs:6:20 ───────────────── M@test.qs:8:20 ──────────────── |0〉@test.qs:8:20 ───────────────────────────────────────────────── X@test.qs:13:20 ──────────────── M@test.qs:15:20 ─────────────── |0〉@test.qs:15:20 ───────────────────── ]] ───────────────
                                         ══════════════ [[ ═════════════════════ [Main@test.qs:2:12] ══════                                                                                  ╘═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╪═══════════════════════════════════════════════════════════════ ]] ═══════════════
                                         ══════════════ [[ ═════════════════════ [Main@test.qs:2:12] ══════                                                                                                                                                                                                                      ╘═══════════════════════════════════════════════════════════════ ]] ═══════════════
...
fn dot_product_phase_estimation() {
    let circ = circuit_static(DOT_PRODUCT_PHASE_ESTIMATION);
    expect![[r#"
...
fn dynamics_small() {
    ...
    expect![[r#"
        Eval:
        q_0@test.qs:136:12 ─────── [[ ───────── [Main@test.qs:4:8] ───────── [[ ───────── [IsingModel2DSim@test.qs:134:8] ──────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.3730)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.5922)@test.qs:116:20 ─── Rzz(0.5922)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.5922)@test.qs:116:20 ─── Rzz(0.5922)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.3730)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── ]] ─────────────── ]] ────────
                                                         ┆                                               ┆                                                  ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆                                                                                                                    ┆                                                              ┆                              ┆                                                                   ┆                                               ┆
        q_1@test.qs:136:12 ─────── [[ ───────── [Main@test.qs:4:8] ───────── [[ ───────── [IsingModel2DSim@test.qs:134:8] ──────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.3730)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.5922)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.5922)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.5922)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.5922)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.3730)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── ]] ─────────────── ]] ────────
                                                         ┆                                               ┆                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                              ┆                                                                                                  ┆                                               ┆
        q_2@test.qs:136:12 ─────── [[ ───────── [Main@test.qs:4:8] ───────── [[ ───────── [IsingModel2DSim@test.qs:134:8] ──────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.3730)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.5922)@test.qs:116:20 ─── Rzz(0.5922)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.5922)@test.qs:116:20 ─── Rzz(0.5922)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─────────────────┆──────────────── Rzz(0.7461)@test.qs:116:20 ─── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.3730)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── ]] ─────────────── ]] ────────
                                                         ┆                                               ┆                                                  ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆                                                                                                                    ┆                               ┆                                                             ┆                                                                   ┆                                               ┆
        q_3@test.qs:136:12 ─────── [[ ───────── [Main@test.qs:4:8] ───────── [[ ───────── [IsingModel2DSim@test.qs:134:8] ──────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.3730)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.5922)@test.qs:116:20 ────────────────────────────────── Rzz(0.5922)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.5922)@test.qs:116:20 ────────────────────────────────── Rzz(0.5922)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(-0.2191)@test.qs:86:28 ──────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.7461)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── [[ ───────── [ApplyDoubleZ@test.qs:103:8] ─── Rzz(0.7461)@test.qs:116:20 ────────────────────────────────── Rzz(0.7461)@test.qs:116:20 ───────── ]] ─────────────── [[ ───────── [ApplyAllX@test.qs:82:8] ───────── [[ ───────── [<lambda>@test.qs:86:28] ─── Rx(0.3730)@test.qs:86:28 ───────── ]] ─────────────── ]] ─────────────── ]] ─────────────── ]] ────────
