    ...
    check_rewrite(
        ...
        &expect![[r#"
            ...
            operation Main() : Unit {
                ...
                Run_closure_5__closure_6_(2, 1, 2);
            }
            operation _lambda_5(arg : Int, (hole : Qubit, hole : Qubit[])) : Unit {
                ApplyParityOperation(arg, hole, hole)
            }
            ...
            operation Run_closure_5__closure_6_(config : Int, __capture_0 : Int, __capture_1 : Int) : Unit {
...
fn indexed_closure_callable_array_tuple_arg_loop_dispatches_closures() {
    ...
    check_rewrite(
        ...
        operation Main() : Unit {
            ...
            Run_Empty__Empty__Empty__PrepareSystems__closure_6__closure_7__PreparePhase_(2, [0, 1], 0, 1, 2);
        }
        operation _lambda_6(arg : Int, (hole : Qubit, hole : Qubit[])) : Unit {
            ApplyParityOperation(arg, hole, hole)
        }
        ...
        operation Run_Empty__Empty__Empty__PrepareSystems__closure_6__closure_7__PreparePhase_(numBits : Int, systems : Int[], numAncillaQubits : Int, __capture_0 : Int, __capture_1 : Int) : Unit {
            let qs : Qubit[] = AllocateQubitArray(numBits + Length(systems) + numAncillaQubits);
            let ancillas : Qubit[] = qs[0..numBits - 1];
            let allTargets : Qubit[] = qs[numBits...];
...
fn indexed_same_target_closure_callable_array_tuple_arg_dispatches_closures() {
    ...
    check_rewrite(
        ...
        operation Main() : Unit {
            ...
            Run_Empty__Empty__Empty__PrepareSystems__closure_6__closure_7__PreparePhase_(2, [0, 1], 0, first, second);
        }
        operation _lambda_6(arg : Int, (hole : Qubit, hole : Qubit[])) : Unit {
            ApplyParityOperation(arg, hole, hole)
        }
...
fn indexed_closure_callable_array_udt_with_callable_siblings_dispatches_closures() {
    ...
    check_rewrite(
        ...
        operation Main() : Unit {
            ...
            Run_PrepareSystems__closure_7__closure_8__PreparePhase_(2, [0, 1], 0, 1, 2);
        }
        operation _lambda_7(arg : Int, (hole : Qubit, hole : Qubit[])) : Unit {
            ApplyParityOperation(arg, hole, hole)
        }
        ...
        operation Run_PrepareSystems__closure_7__closure_8__PreparePhase_(config : (Int, Int[], Int), __capture_0 : Int, __capture_1 : Int) : Unit {
