    ...
    check_analysis_with_capabilities(
        ...
        &expect![[r#"
            callable_params: 3
              ...
              param: callable_id=<item 1020 in package 1>, path=[1], ty=((Qubit)[] => Unit is Adj + Ctl)
            call_sites: 5
    ...
    check_rewrite_with_capabilities(
        ...
        &expect![[r#"
            ...
            operation ApplyOperationPowerCA__Qubit_____AdjCtl__U_(power : Int, target : Qubit[]) : Unit is Adj + Ctl {
                body ... {
                    {
                        let _range_id_48122 : Range = 1..AbsI(power);
                        mutable _index_id_48125 : Int = _range_id_48122::Start;
                        let _step_id_48130 : Int = _range_id_48122::Step;
                        let _end_id_48135 : Int = _range_id_48122::End;
                        while _step_id_48130 > 0 and _index_id_48125 <= _end_id_48135 or _step_id_48130 < 0 and _index_id_48125 >= _end_id_48135 {
                            let _ : Int = _index_id_48125;
                            if power >= 0 {
                                U(target)
                            } else {
                                Adjoint U(target)
                            };
                            _index_id_48125 += _step_id_48130;
                        }
                ...
                adjoint ... {
                    {
                        ...
                        {
                            let _range_id_48165 : Range = _range::Start + _range::End - _range::Start / _range::Step * _range::Step..-_range::Step.._range::Start;
                            mutable _index_id_48168 : Int = _range_id_48165::Start;
                            let _step_id_48173 : Int = _range_id_48165::Step;
                            let _end_id_48178 : Int = _range_id_48165::End;
                            while _step_id_48173 > 0 and _index_id_48168 <= _end_id_48178 or _step_id_48173 < 0 and _index_id_48168 >= _end_id_48178 {
                                let _ : Int = _index_id_48168;
                                if power >= 0 {
                                    Adjoint U(target)
                                } else {
                                    U(target)
                                };
                                _index_id_48168 += _step_id_48173;
                            }
                ...
                controlled (ctls, ...) {
                    {
                        let _range_id_48208 : Range = 1..AbsI(power);
                        mutable _index_id_48211 : Int = _range_id_48208::Start;
                        let _step_id_48216 : Int = _range_id_48208::Step;
                        let _end_id_48221 : Int = _range_id_48208::End;
                        while _step_id_48216 > 0 and _index_id_48211 <= _end_id_48221 or _step_id_48216 < 0 and _index_id_48211 >= _end_id_48221 {
                            let _ : Int = _index_id_48211;
                            if power >= 0 {
                                Controlled U(ctls, target)
                            } else {
                                Controlled Adjoint U(ctls, target)
                            };
                            _index_id_48211 += _step_id_48216;
                        }
                ...
                controlled adjoint (ctls, ...) {
                    {
                        let _range : Range = 1..AbsI(power);
                        {
                            let _range_id_48251 : Range = _range::Start + _range::End - _range::Start / _range::Step * _range::Step..-_range::Step.._range::Start;
                            mutable _index_id_48254 : Int = _range_id_48251::Start;
                            let _step_id_48259 : Int = _range_id_48251::Step;
                            let _end_id_48264 : Int = _range_id_48251::End;
                            while _step_id_48259 > 0 and _index_id_48254 <= _end_id_48264 or _step_id_48259 < 0 and _index_id_48254 >= _end_id_48264 {
                                let _ : Int = _index_id_48254;
                                if power >= 0 {
                                    Controlled Adjoint U(ctls, target)
                                } else {
                                    Controlled U(ctls, target)
                                };
                                _index_id_48254 += _step_id_48259;
                            }
...
fn analysis_bernstein_vazirani_sample_shape() {
    ...
    check_analysis_with_capabilities(
        ...
        &expect![[r#"
            callable_params: 2
              param: callable_id=<item 1020 in package 1>, path=[0], ty=(Qubit => Unit is Adj + Ctl)
    ...
    check_rewrite_with_capabilities(
        ...
        &expect![[r#"
            ...
            operation ApplyToEachA_Qubit__AdjCtl__H_(register : Qubit[]) : Unit is Adj {
                body ... {
                    {
                        let _array_id_46339 : Qubit[] = register;
                        let _len_id_46343 : Int = Length(_array_id_46339);
                        mutable _index_id_46348 : Int = 0;
                        while _index_id_46348 < _len_id_46343 {
                            let item : Qubit = _array_id_46339[_index_id_46348];
                            H(item);
                            _index_id_46348 += 1;
                        }
                ...
                adjoint ... {
                    {
                        ...
                        {
                            let _range_id_46367 : Range = Length(_array) - 1..-1..0;
                            mutable _index_id_46370 : Int = _range_id_46367::Start;
                            let _step_id_46375 : Int = _range_id_46367::Step;
                            let _end_id_46380 : Int = _range_id_46367::End;
                            while _step_id_46375 > 0 and _index_id_46370 <= _end_id_46380 or _step_id_46375 < 0 and _index_id_46370 >= _end_id_46380 {
                                let _index : Int = _index_id_46370;
                                let item : Qubit = _array[_index];
                                Adjoint H(item);
                                _index_id_46370 += _step_id_46375;
                            }
    ...
    check_rewrite(
        ...
        &expect![[r#"
            ...
            operation ApplyToEach_Qubit__AdjCtl__H_(register : Qubit[]) : Unit {
                {
                    let _array_id_46301 : Qubit[] = register;
                    let _len_id_46305 : Int = Length(_array_id_46301);
                    mutable _index_id_46310 : Int = 0;
                    while _index_id_46310 < _len_id_46305 {
                        let item : Qubit = _array_id_46301[_index_id_46310];
                        H(item);
                        _index_id_46310 += 1;
                    }
    ...
    check_rewrite(
        ...
        &expect![[r#"
            ...
            operation ApplyToEachA_Qubit__AdjCtl__S_(register : Qubit[]) : Unit is Adj {
                body ... {
                    {
                        let _array_id_46329 : Qubit[] = register;
                        let _len_id_46333 : Int = Length(_array_id_46329);
                        mutable _index_id_46338 : Int = 0;
                        while _index_id_46338 < _len_id_46333 {
                            let item : Qubit = _array_id_46329[_index_id_46338];
                            S(item);
                            _index_id_46338 += 1;
                        }
                ...
                adjoint ... {
                    {
                        let _array : Qubit[] = register;
                        {
                            let _range_id_46357 : Range = Length(_array) - 1..-1..0;
                            mutable _index_id_46360 : Int = _range_id_46357::Start;
                            let _step_id_46365 : Int = _range_id_46357::Step;
                            let _end_id_46370 : Int = _range_id_46357::End;
                            while _step_id_46365 > 0 and _index_id_46360 <= _end_id_46370 or _step_id_46365 < 0 and _index_id_46360 >= _end_id_46370 {
                                let _index : Int = _index_id_46360;
                                let item : Qubit = _array[_index];
                                Adjoint S(item);
                                _index_id_46360 += _step_id_46365;
                            }
    ...
    check_rewrite(
        ...
        &expect![[r#"
            ...
            operation ApplyToEachC_Qubit__AdjCtl__X_(register : Qubit[]) : Unit is Ctl {
                body ... {
                    {
                        let _array_id_46400 : Qubit[] = register;
                        let _len_id_46404 : Int = Length(_array_id_46400);
                        mutable _index_id_46409 : Int = 0;
                        while _index_id_46409 < _len_id_46404 {
                            let item : Qubit = _array_id_46400[_index_id_46409];
                            X(item);
                            _index_id_46409 += 1;
                        }
                ...
                controlled (ctls, ...) {
                    {
                        let _array_id_46428 : Qubit[] = register;
                        let _len_id_46432 : Int = Length(_array_id_46428);
                        mutable _index_id_46437 : Int = 0;
                        while _index_id_46437 < _len_id_46432 {
                            let item : Qubit = _array_id_46428[_index_id_46437];
    ...
    check_rewrite(
        ...
        &expect![[r#"
            ...
            operation ApplyToEachCA_Qubit__AdjCtl__S_(register : Qubit[]) : Unit is Adj + Ctl {
                body ... {
                    {
                        let _array_id_46456 : Qubit[] = register;
                        let _len_id_46460 : Int = Length(_array_id_46456);
                        mutable _index_id_46465 : Int = 0;
                        while _index_id_46465 < _len_id_46460 {
                            let item : Qubit = _array_id_46456[_index_id_46465];
                            S(item);
                            _index_id_46465 += 1;
                        }
                ...
                adjoint ... {
                    {
                        let _array : Qubit[] = register;
                        {
                            let _range_id_46484 : Range = Length(_array) - 1..-1..0;
                            mutable _index_id_46487 : Int = _range_id_46484::Start;
                            let _step_id_46492 : Int = _range_id_46484::Step;
                            let _end_id_46497 : Int = _range_id_46484::End;
                            while _step_id_46492 > 0 and _index_id_46487 <= _end_id_46497 or _step_id_46492 < 0 and _index_id_46487 >= _end_id_46497 {
                                let _index : Int = _index_id_46487;
                                let item : Qubit = _array[_index];
                                Adjoint S(item);
                                _index_id_46487 += _step_id_46492;
                            }
                ...
                controlled (ctls, ...) {
                    {
                        let _array_id_46527 : Qubit[] = register;
                        let _len_id_46531 : Int = Length(_array_id_46527);
                        mutable _index_id_46536 : Int = 0;
                        while _index_id_46536 < _len_id_46531 {
                            let item : Qubit = _array_id_46527[_index_id_46536];
                ...
                controlled adjoint (ctls, ...) {
                    {
                        let _array : Qubit[] = register;
                        {
                            let _range_id_46555 : Range = Length(_array) - 1..-1..0;
                            mutable _index_id_46558 : Int = _range_id_46555::Start;
                            let _step_id_46563 : Int = _range_id_46555::Step;
                            let _end_id_46568 : Int = _range_id_46555::End;
                            while _step_id_46563 > 0 and _index_id_46558 <= _end_id_46568 or _step_id_46563 < 0 and _index_id_46558 >= _end_id_46568 {
                                let _index : Int = _index_id_46558;
                                let item : Qubit = _array[_index];
                                Controlled Adjoint S(ctls, item);
                                _index_id_46558 += _step_id_46563;
                            }
    ...
    check_rewrite(
        ...
        &expect![[r#"
            ...
            function Mapped_Int__Int__Double_(array : Int[]) : Int[] {
                mutable mapped : Int[] = [];
                {
                    let _array_id_45815 : Int[] = array;
                    let _len_id_45819 : Int = Length(_array_id_45815);
                    mutable _index_id_45824 : Int = 0;
                    while _index_id_45824 < _len_id_45819 {
                        let element : Int = _array_id_45815[_index_id_45824];
    ...
    check_rewrite(
        ...
        &expect![[r#"
            ...
            operation ForEach_Qubit__Unit__AdjCtl__H_(array : Qubit[]) : Unit[] {
                mutable output : Unit[] = [];
                {
                    let _array_id_45587 : Qubit[] = array;
                    let _len_id_45591 : Int = Length(_array_id_45587);
                    mutable _index_id_45596 : Int = 0;
                    while _index_id_45596 < _len_id_45591 {
                        let element : Qubit = _array_id_45587[_index_id_45596];
                        output += [H(element)];
                        _index_id_45596 += 1;
                    }
    ...
    check_rewrite(
        ...
        &expect![[r#"
            ...
            function Fold_Int__Int__closure_(state : Int, array : Int[]) : Int {
                ...
                {
                    let _array_id_45559 : Int[] = array;
                    let _len_id_45563 : Int = Length(_array_id_45559);
                    mutable _index_id_45568 : Int = 0;
                    while _index_id_45568 < _len_id_45563 {
                        let element : Int = _array_id_45559[_index_id_45568];
