...
fn assert_while_condition_return_flag_shape(source: &str, expected_ret_val: i64) {
    ...
    let has_returned_var_id =
        find_top_level_local_var_id(package, body_block_id, symbols::HAS_RETURNED);
    let ret_val_var_id = find_top_level_local_var_id(package, body_block_id, symbols::RET_VAL);
