    ...
    check_to(
        ...
        &expect![[r#"
            Callable Foo: input=Tuple()
              local: Tuple(Bind(t_0: Int), Bind(t_1: Int))
              local: Bind(a: Int)
              local: Bind(b: Int)
            Callable Main: input=Tuple()"#]],
    );
    ...
    check_to(
        ...
        &expect![[r#"
            Callable Main: input=Tuple()
              ...
              local: Bind(b: Int)
              local: Bind(c: Int)
              local: Tuple(Bind(t_0: Int), Tuple(Bind(t_1_0: Int), Bind(t_1_1: Int)))
              local: Bind(x: Int)
              local: Bind(y: Int)
              local: Bind(z: Int)"#]],
    );
    ...
    check_to(
        ...
        &expect![[r#"
            Callable Main: input=Tuple()
              local: Bind(a: Int)
              local: Bind(b: Int)
              local: Tuple(Bind(pair_0: Int), Bind(pair_1: Int))
              local: Bind(t_0: Int)
              local: Bind(t_1: Int)
              local: Bind(x: Int)
              local: Bind(y: Int)"#]],
    ...
    check_to(
        ...
        &expect![[r#"
            Callable Main: input=Tuple()
              ...
              local: Bind(c: Int)
              local: Bind(d: Int)
              local: Tuple(Bind(t_0: Int), Tuple(Bind(t_1_0: Int), Tuple(Bind(t_1_1_0: Int), Bind(t_1_1_1: Int))))
              local: Bind(w: Int)
              local: Bind(x: Int)
              local: Bind(y: Int)
              local: Bind(z: Int)"#]],
