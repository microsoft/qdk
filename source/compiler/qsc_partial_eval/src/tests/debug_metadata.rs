    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                ...
                1 = SubProgram name=H location=(1-111899)
            dbg_locations:
                [1]: scope=0 location=(2-99)
                [2]: scope=1 location=(1-111971) inlined_at=1"#]],
    );
}
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                0 = SubProgram name=Main location=(2-40)
                1 = SubProgram name=H location=(1-111899)
                2 = SubProgram name=M location=(1-113608)
            dbg_locations:
                [1]: scope=0 location=(2-103)
                [2]: scope=1 location=(1-111971) inlined_at=1
                [3]: scope=0 location=(2-126)
                [4]: scope=2 location=(1-113650) inlined_at=3"#]],
    );
}
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                ...
                2 = SubProgram name=H location=(1-111899)
                3 = SubProgram name=MResetZ location=(1-182952)
            dbg_locations:
                [1]: scope=0 location=(2-99)
                [2]: scope=1 location=(2-179) inlined_at=1
                [3]: scope=2 location=(1-111971) inlined_at=2
                [4]: scope=0 location=(2-115)
                [5]: scope=3 location=(1-183001) inlined_at=4"#]],
    );
}
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                ...
                3 = SubProgram name=X location=(1-134701)
                4 = SubProgram name=Y location=(1-135923)
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                ...
                8 = SubProgram name=X location=(1-134701)
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                ...
                2 = SubProgram name=M location=(1-113608)
                3 = SubProgram name=X location=(1-134701)
                4 = SubProgram name=Reset location=(1-118001)
            dbg_locations:
                ...
                [6]: scope=3 location=(1-134773) inlined_at=5
                [7]: scope=0 location=(2-125)
                [8]: scope=0 location=(2-179)
                [9]: scope=4 location=(1-118045) inlined_at=8"#]],
    );
}
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_locations:
                ...
                [3]: scope=1 location=(1-111971) inlined_at=2
                [4]: scope=0 location=(2-135)
                [5]: scope=2 location=(1-113650) inlined_at=4
                [6]: scope=0 location=(2-176)
                [7]: scope=3 location=(1-134773) inlined_at=6
                [8]: scope=0 location=(2-212)
                [9]: scope=4 location=(1-135995) inlined_at=8
                [10]: scope=0 location=(2-150)
                [11]: scope=0 location=(2-246)
                [12]: scope=2 location=(1-113650) inlined_at=11"#]],
    );
}
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_locations:
                ...
                [5]: scope=1 location=(1-111971) inlined_at=4
                [6]: scope=0 location=(2-107)
                [7]: scope=2 location=(1-113650) inlined_at=6
                [8]: scope=0 location=(2-129)
                [9]: scope=2 location=(1-113650) inlined_at=8
