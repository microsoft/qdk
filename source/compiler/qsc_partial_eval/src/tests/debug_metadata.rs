    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                ...
                3 = SubProgram name=X location=(1-135165)
                4 = SubProgram name=Y location=(1-136387)
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                ...
                8 = SubProgram name=X location=(1-135165)
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_scopes:
                ...
                2 = SubProgram name=M location=(1-112934)
                3 = SubProgram name=X location=(1-135165)
                4 = SubProgram name=Reset location=(1-118465)
            dbg_locations:
                ...
                [6]: scope=3 location=(1-135237) inlined_at=5
                [7]: scope=0 location=(2-125)
                [8]: scope=0 location=(2-179)
                [9]: scope=4 location=(1-118509) inlined_at=8"#]],
    );
}
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            dbg_locations:
                ...
                [7]: scope=3 location=(1-135237) inlined_at=6
                [8]: scope=0 location=(2-212)
                [9]: scope=4 location=(1-136459) inlined_at=8
