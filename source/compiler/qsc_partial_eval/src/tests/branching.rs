...
fn if_elif_else_expression_with_dynamic_condition() {
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 1:Block:
                Call id(7), args( Integer(0), EmptyTag, ) !dbg
                Return !dbg
            Block 2:Block:
...
fn doubly_nested_if_else_expressions_with_dynamic_conditions() {
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 1:Block:
                Call id(8), args( Integer(0), EmptyTag, ) !dbg
                Return !dbg
            Block 2:Block:
                Variable(2, Boolean) = Call id(3), args( Result(1), ) !dbg dbg_location=4
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 0:Block:
                ...
                Call id(5), args( Result(1), Tag(1, 5), ) !dbg
                Return !dbg"#]],
    );
}
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 1:Block:
                ...
                Call id(6), args( Result(0), Tag(0, 5), ) !dbg
                Call id(6), args( Result(1), Tag(1, 5), ) !dbg
                Return !dbg
            Block 2:Block:
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 0:Block:
                ...
                Call id(5), args( Integer(2), EmptyTag, ) !dbg
                Call id(6), args( Variable(1, Boolean), Tag(0, 5), ) !dbg
                Call id(6), args( Variable(3, Boolean), Tag(1, 5), ) !dbg
                Return !dbg"#]],
    );
}
...
fn if_expression_with_classical_operand_from_hybrid_integers_array() {
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 4:Block:
                Call id(5), args( Integer(2), EmptyTag, ) !dbg
                Call id(6), args( Variable(2, Integer), Tag(0, 5), ) !dbg
                Call id(6), args( Variable(5, Integer), Tag(1, 5), ) !dbg
                Return !dbg
            Block 5:Block:
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 6:Block:
                Call id(5), args( Integer(2), EmptyTag, ) !dbg
                Call id(6), args( Variable(2, Integer), Tag(0, 5), ) !dbg
                Call id(6), args( Variable(6, Integer), Tag(1, 5), ) !dbg
                Return !dbg
            Block 7:Block:
...
fn if_expression_with_classical_operand_from_hybrid_doubles_array() {
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 4:Block:
                Call id(5), args( Integer(2), EmptyTag, ) !dbg
                Call id(6), args( Variable(2, Double), Tag(0, 5), ) !dbg
                Call id(6), args( Variable(5, Double), Tag(1, 5), ) !dbg
                Return !dbg
            Block 5:Block:
    ...
    assert_blocks(
        ...
        &expect![[r#"
            ...
            Block 6:Block:
                Call id(5), args( Integer(2), EmptyTag, ) !dbg
                Call id(6), args( Variable(2, Double), Tag(0, 5), ) !dbg
                Call id(6), args( Variable(6, Double), Tag(1, 5), ) !dbg
                Return !dbg
            Block 7:Block:
