    ...
    expect![[r#"
        Program:
            ...
            dbg_metadata_scopes:
                ...
                3 = SubProgram name=MResetEachZ location=(package_id=1 span=[179774-179943]) item_id=((1, 503))
                4 = SubProgram name=MResetZ location=(package_id=1 span=[181274-181362]) item_id=((1, 506))
            ...
            dbg_locations:
                ...
                [4]:  scope=3location=(package_id=1 span=[179907-179921]) inlined_at=3
                [5]:  scope=4location=(package_id=1 span=[181323-181360]) inlined_at=4
                [6]:  scope=3location=(package_id=1 span=[179907-179921]) inlined_at=3
                [7]:  scope=4location=(package_id=1 span=[181323-181360]) inlined_at=6
