...
pub const ARITHMETICOPERATORS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const ARRAY_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1513"];
...
pub const BIGINT_EXPECT_QIR_ADAPTIVE_RIF: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
pub const BIGINT_EXPECT_QIR_ADAPTIVE: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
...
pub const BITWISEOPERATORS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const BOOL_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1034"];
...
pub const BREAKANDCONTINUE_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1410"];
...
pub const COMMENTS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const COMPARISONOPERATORS_EXPECT_QIR_ADAPTIVE_RIF: Expect =
    expect!["generated QIR of length 960"];
pub const COMPARISONOPERATORS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const CUSTOMMEASUREMENTS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1406"];
...
pub const DATATYPES_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const DIAGNOSTICS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 2207"];
...
pub const DOUBLE_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1054"];
...
pub const ENTRYPOINT_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const FAILSTATEMENT_EXPECT_QIR_ADAPTIVE_RIF: Expect =
    expect!["QIR generation error for `FailStatement.Main()`: partial evaluation error"];
pub const FAILSTATEMENT_EXPECT_QIR_ADAPTIVE: Expect =
    expect!["QIR generation error for `FailStatement.Main()`: partial evaluation error"];
...
pub const FORLOOPS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const FUNCTIONS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const GETTINGSTARTED_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const INT_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1031"];
...
pub const LAMBDAEXPRESSION_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const LOGICALOPERATORS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const NAMESPACES_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const PARTIALAPPLICATION_EXPECT_QIR_ADAPTIVE_RIF: Expect =
    expect!["generated QIR of length 960"];
pub const PARTIALAPPLICATION_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const PAULI_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1785"];
...
pub const QUANTUMMEMORY_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1036"];
...
pub const QUBIT_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 2532"];
...
pub const RANGE_EXPECT_CIRCUIT: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
pub const RANGE_EXPECT_QIR_ADAPTIVE_RIF: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
pub const RANGE_EXPECT_QIR_ADAPTIVE: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
...
pub const REPEATUNTILLOOPS_EXPECT_QIR_ADAPTIVE_RIF: Expect =
    expect!["compilation error: cannot have a loop with a dynamic condition"];
pub const REPEATUNTILLOOPS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 2125"];
...
pub const RESULT_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1621"];
...
pub const RETURNSTATEMENT_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const SPECIALIZATIONS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 6367"];
...
pub const STRING_EXPECT_CIRCUIT: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
pub const STRING_EXPECT_QIR_ADAPTIVE_RIF: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
pub const STRING_EXPECT_QIR_ADAPTIVE: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
...
pub const TERNARY_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const TUPLE_EXPECT_CIRCUIT: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
pub const TUPLE_EXPECT_QIR_ADAPTIVE_RIF: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
pub const TUPLE_EXPECT_QIR_ADAPTIVE: Expect =
    expect!["compilation error: cannot use value with advanced type as an output"];
...
pub const TYPEDECLARATIONS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const UNIT_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const VARIABLES_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const WHILELOOPS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const WITHINAPPLY_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1595"];
...
pub const CLASSCONSTRAINTS_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
...
pub const TESTATTRIBUTE_EXPECT_QIR_ADAPTIVE: Expect = expect!["generated QIR of length 1035"];
