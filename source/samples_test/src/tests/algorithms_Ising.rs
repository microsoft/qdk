...
pub const SIMPLE2DISINGORDER2_EXPECT: Expect = expect!["[Zero, Zero, Zero, One, One, Zero, One, Zero, One]"];
pub const SIMPLE2DISINGORDER2_EXPECT_DEBUG: Expect = expect!["[Zero, Zero, Zero, One, One, Zero, One, Zero, One]"];
...
pub const SIMPLE1DISINGORDER1_EXPECT: Expect = expect!["[Zero, Zero, Zero, One, One, Zero, Zero, Zero, Zero]"];
pub const SIMPLE1DISINGORDER1_EXPECT_DEBUG: Expect = expect!["[Zero, Zero, Zero, One, One, Zero, Zero, Zero, Zero]"];
...
pub const SIMPLE2DISINGORDER1_EXPECT: Expect = expect!["[Zero, Zero, Zero, One, One, Zero, One, One, Zero]"];
pub const SIMPLE2DISINGORDER1_EXPECT_DEBUG: Expect = expect!["[Zero, Zero, Zero, One, One, Zero, One, One, Zero]"];
