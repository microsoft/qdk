...
import pytest
from qdk.qsharp import estimate_custom
...
def test_wrong_input():
    pytest.raises(AttributeError, estimate_custom, 42, sample_qubit(), SampleCode())
...
def test_estimate_without_factories():
    result = estimate_custom(SampleAlgorithm(), sample_qubit(), SampleCode())
