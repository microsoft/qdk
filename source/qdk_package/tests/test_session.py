...
def test_compile() -> None:
    s = qdk.Session(target_profile=qdk.TargetProfile.Base)
...
def test_dump_machine() -> None:
    s = qdk.Session(target_profile=qdk.TargetProfile.Unrestricted)
...
def test_cross_session_callable_passing_raises() -> None:
    session_a = qdk.Session()
    session_b = qdk.Session()
