...
impl CircuitConfig {
    #[new]
    #[pyo3(signature=(*,max_operations=None, max_loop_iterations=TracerConfig::DEFAULT_MAX_LOOP_ITERATIONS, generation_method=None, source_locations=false, group_by_scope=false, prune_classical_qubits=false))]
    fn new(
