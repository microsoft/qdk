...
use crate::{
    ...
    qasm_ast::register_qasm_ast_submodule,
    qir_simulation::{
...
fn verify_classes_are_sendable() {
    ...
    // The `qdk.openqasm` AST classes are exposed as `#[pyclass(frozen)]` and must
    // be both `Send` and `Sync` (PyO3 0.29 requires both for shared pyclasses).
    is_send::<crate::qasm_ast::QASMNode>();
    is_sync::<crate::qasm_ast::QASMNode>();
    is_send::<crate::qasm_ast::Expression>();
    is_sync::<crate::qasm_ast::Expression>();
    is_send::<crate::qasm_ast::Statement>();
    is_sync::<crate::qasm_ast::Statement>();
    is_send::<crate::qasm_ast::Program>();
    is_sync::<crate::qasm_ast::Program>();
    is_send::<crate::qasm_ast::QuantumGateModifier>();
    is_sync::<crate::qasm_ast::QuantumGateModifier>();
    is_send::<crate::qasm_ast::Span>();
    is_sync::<crate::qasm_ast::Span>();
    is_send::<crate::qasm_ast::Diagnostic>();
    is_sync::<crate::qasm_ast::Diagnostic>();
    is_send::<crate::qasm_ast::Label>();
    is_sync::<crate::qasm_ast::Label>();
    is_send::<crate::qasm_ast::Severity>();
    is_sync::<crate::qasm_ast::Severity>();
    is_send::<crate::qasm_ast::PositionEncoding>();
    is_sync::<crate::qasm_ast::PositionEncoding>();
    is_send::<crate::qasm_ast::Position>();
    is_sync::<crate::qasm_ast::Position>();
    is_send::<crate::qasm_ast::SourceRange>();
    is_sync::<crate::qasm_ast::SourceRange>();
    is_send::<crate::qasm_ast::SourceEdit>();
    is_sync::<crate::qasm_ast::SourceEdit>();
    is_send::<crate::qasm_ast::SourceFile>();
    is_sync::<crate::qasm_ast::SourceFile>();
    is_send::<crate::qasm_ast::SourceMap>();
    is_sync::<crate::qasm_ast::SourceMap>();
    is_send::<crate::qasm_ast::SourceDocument>();
    is_sync::<crate::qasm_ast::SourceDocument>();
    is_send::<crate::qasm_ast::RawTokenKind>();
    is_sync::<crate::qasm_ast::RawTokenKind>();
    is_send::<crate::qasm_ast::RawToken>();
    is_sync::<crate::qasm_ast::RawToken>();

    // The semantic `qdk.openqasm` projection classes. The per-variant leaf node
    // classes generated by the `qasm_node!` macro assert `Send + Sync` at their
    // definition site, so only the hand-written classes are checked here.
    is_send::<crate::qasm_ast::SemProgram>();
    is_sync::<crate::qasm_ast::SemProgram>();
    is_send::<crate::qasm_ast::SemExpr>();
    is_sync::<crate::qasm_ast::SemExpr>();
    is_send::<crate::qasm_ast::SemStmt>();
    is_sync::<crate::qasm_ast::SemStmt>();
    is_send::<crate::qasm_ast::SemHardwareQubit>();
    is_sync::<crate::qasm_ast::SemHardwareQubit>();
    is_send::<crate::qasm_ast::SemType>();
    is_sync::<crate::qasm_ast::SemType>();
    is_send::<crate::qasm_ast::SemSymbol>();
    is_sync::<crate::qasm_ast::SemSymbol>();
    is_send::<crate::qasm_ast::SemSymbolTable>();
    is_sync::<crate::qasm_ast::SemSymbolTable>();
}
