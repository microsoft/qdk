...
class OptimizeSingleQubitGates(QirModuleVisitor):
    ...
    def _drop_ops(self, qubits: list[Value]) -> None:
    ...
    def _schedule_gate(
        self, instr: Call, key: int | None, name: str, adj: str
    ) -> None:
    ...
    def _schedule_rotation(self, instr: Call, key: int | None, name: str) -> None:
