...
def circuit(
    ...
    **kwargs: Any,
    ...
    """
    Synthesize a circuit from OpenQASM source or an imported operation.
    ...
    :raises qdk.qsharp.QSharpError: If there is an error evaluating or synthesizing the circuit.
    :raises ValueError: If ``source`` is neither OpenQASM source text nor an
        imported callable.
    """
