...
block_1:
  ...
  %var_3 = icmp slt i64 %var_14, 5
  br i1 %var_3, label %block_2, label %block_3
block_2:
  %var_20 = load i64, ptr %var_2
  %var_4 = getelementptr ptr, ptr @array0, i64 %var_20
  %var_21 = load ptr, ptr %var_4
...
block_3:
  ...
  store i64 4, ptr %var_8
  br label %block_4
block_4:
  %var_16 = load i64, ptr %var_8
  %var_9 = icmp sge i64 %var_16, 0
  br i1 %var_9, label %block_5, label %block_6
block_5:
  %var_17 = load i64, ptr %var_8
  %var_10 = getelementptr ptr, ptr @array0, i64 %var_17
  %var_18 = load ptr, ptr %var_10
  call void @__quantum__qis__h__body(ptr %var_18)
