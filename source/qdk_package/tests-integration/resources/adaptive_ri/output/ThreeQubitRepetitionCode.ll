...
block_0:
  ...
  %var_10 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 0 to %Result*))
  br i1 %var_10, label %block_1, label %block_2
block_1:
  %var_12 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 1 to %Result*))
  br i1 %var_12, label %block_3, label %block_4
block_2:
...
block_11:
  ...
  br i1 %var_24, label %block_12, label %block_13
block_12:
  %var_26 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 3 to %Result*))
...
block_22:
  ...
  %var_39 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 4 to %Result*))
  br i1 %var_39, label %block_23, label %block_24
block_23:
  %var_41 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 5 to %Result*))
  br i1 %var_41, label %block_25, label %block_26
block_24:
  %var_43 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 5 to %Result*))
  br i1 %var_43, label %block_27, label %block_28
block_25:
  call void @__quantum__qis__x__body(%Qubit* inttoptr (i64 1 to %Qubit*))
  br label %block_29
block_26:
...
block_33:
  ...
  %var_54 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 6 to %Result*))
  br i1 %var_54, label %block_34, label %block_35
block_34:
  %var_56 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 7 to %Result*))
  br i1 %var_56, label %block_36, label %block_37
block_35:
  %var_58 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 7 to %Result*))
  br i1 %var_58, label %block_38, label %block_39
block_36:
  call void @__quantum__qis__x__body(%Qubit* inttoptr (i64 1 to %Qubit*))
  br label %block_40
block_37:
...
block_44:
  ...
  %var_69 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 8 to %Result*))
  br i1 %var_69, label %block_45, label %block_46
block_45:
  %var_71 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 9 to %Result*))
  br i1 %var_71, label %block_47, label %block_48
block_46:
  %var_73 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 9 to %Result*))
  br i1 %var_73, label %block_49, label %block_50
block_47:
  call void @__quantum__qis__x__body(%Qubit* inttoptr (i64 1 to %Qubit*))
  br label %block_51
block_48:
...
block_55:
  ...
  %var_77 = call i1 @__quantum__rt__read_result(%Result* inttoptr (i64 10 to %Result*))
  ...
  call void @__quantum__rt__bool_record_output(i1 %var_77, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i64 0, i64 0))
  call void @__quantum__rt__int_record_output(i64 %var_95, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @2, i64 0, i64 0))
  ret i64 0
}
