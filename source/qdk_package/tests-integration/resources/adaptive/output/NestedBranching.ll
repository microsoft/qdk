...
define void @Y(ptr %var_62) {
block_96:
  call void @__quantum__qis__y__body(ptr %var_62)
  ret void
}

declare void @__quantum__qis__y__body(ptr)

define void @Z(ptr %var_63) {
block_97:
  call void @__quantum__qis__z__body(ptr %var_63)
  ret void
}
