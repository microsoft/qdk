...
block_2:
  ...
  store i1 %var_6, ptr %var_1
  %var_15 = load i1, ptr %var_1
  br i1 %var_15, label %block_3, label %block_4
block_3:
...
block_5:
  ...
  %var_9 = icmp slt i64 %var_17, 2
  br i1 %var_9, label %block_6, label %block_7
block_6:
