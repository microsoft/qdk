...
block_3:
  ...
  store i64 4, ptr %var_9
  br label %block_4
block_4:
  %var_17 = load i64, ptr %var_9
  %var_10 = icmp sge i64 %var_17, 0
  br i1 %var_10, label %block_5, label %block_6
block_5:
  %var_18 = load i64, ptr %var_9
  %var_11 = getelementptr ptr, ptr @array0, i64 %var_18
  %var_19 = load ptr, ptr %var_11
