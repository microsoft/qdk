...
pub fn walk_assign_op_stmt(vis: &mut impl MutVisitor, stmt: &mut AssignOpStmt) {
    vis.visit_span(&mut stmt.span);
    vis.visit_ident_or_indexed_ident(&mut stmt.lhs);
...
pub fn walk_block_stmt(vis: &mut impl MutVisitor, stmt: &mut Block) {
    vis.visit_span(&mut stmt.span);
    stmt.stmts.iter_mut().for_each(|stmt| vis.visit_stmt(stmt));
}

pub fn walk_cal_stmt(vis: &mut impl MutVisitor, stmt: &mut CalibrationStmt) {
    vis.visit_span(&mut stmt.span);
}
...
pub fn walk_const_decl_stmt(vis: &mut impl MutVisitor, stmt: &mut ConstantDeclStmt) {
    vis.visit_span(&mut stmt.span);
    vis.visit_tydef(&mut stmt.ty);
    vis.visit_ident(&mut stmt.identifier);
...
pub fn walk_extern_stmt(vis: &mut impl MutVisitor, stmt: &mut ExternDecl) {
    vis.visit_span(&mut stmt.span);
...
pub fn walk_gphase_stmt(vis: &mut impl MutVisitor, stmt: &mut GPhase) {
    vis.visit_span(&mut stmt.span);
...
pub fn walk_io_declaration_stmt(vis: &mut impl MutVisitor, stmt: &mut IODeclaration) {
    vis.visit_span(&mut stmt.span);
    vis.visit_tydef(&mut stmt.ty);
    vis.visit_ident(&mut stmt.ident);
}

pub fn walk_measure_stmt(vis: &mut impl MutVisitor, stmt: &mut MeasureArrowStmt) {
    vis.visit_span(&mut stmt.span);
    stmt.target
        .iter_mut()
...
pub fn walk_pragma_stmt(vis: &mut impl MutVisitor, stmt: &mut Pragma) {
    vis.visit_span(&mut stmt.span);
}

pub fn walk_quantum_gate_definition_stmt(
    vis: &mut impl MutVisitor,
    stmt: &mut QuantumGateDefinition,
) {
    vis.visit_span(&mut stmt.span);
    vis.visit_ident(&mut stmt.ident);
...
pub fn walk_quantum_decl_stmt(vis: &mut impl MutVisitor, stmt: &mut QubitDeclaration) {
    vis.visit_span(&mut stmt.span);
...
pub fn walk_while_loop_stmt(vis: &mut impl MutVisitor, stmt: &mut WhileLoop) {
    vis.visit_span(&mut stmt.span);
