...
pub enum SemanticErrorKind {
    ...
    #[diagnostic(code("Qdk.Qasm.Lowerer.CannotUpdateConstVariable"))]
    ...
    #[diagnostic(code("Qdk.Qasm.Lowerer.CannotUpdateReadonlyArrayRef"))]
    ...
    #[diagnostic(code("Qdk.Qasm.Lowerer.ForIterableInvalidExpression"))]
    ForIterableInvalidExpression(#[label] Span),
    #[error("for statements must have a body or statement")]
    #[diagnostic(code("Qdk.Qasm.Lowerer.ForStatementsMustHaveABodyOrStatement"))]
    ...
    #[diagnostic(code("Qdk.Qasm.Lowerer.FuncCalledLikeGate"))]
    ...
    #[diagnostic(code("Qdk.Qasm.Lowerer.FuncMissingParams"))]
    ...
    #[diagnostic(code("Qdk.Qasm.Lowerer.GateCalledLikeFunc"))]
    ...
    #[error("include {0} was not resolved before lowering")]
    #[diagnostic(code("Qdk.Qasm.Lowerer.IncludeNotResolved"))]
    IncludeNotResolved(String, #[label] Span),
    ...
    #[diagnostic(code("Qdk.Qasm.Lowerer.InvalidTypeInArrayConcatenation"))]
    ...
    #[diagnostic(code("Qdk.Qasm.Lowerer.MeasureExpressionsMustHaveName"))]
    MeasureExpressionsMustHaveName(#[label] Span),
    #[error("measure statements must have a gate operand name")]
    #[diagnostic(code("Qdk.Qasm.Lowerer.MeasureExpressionsMustHaveGateOperand"))]
