...
pub(crate) struct CuTensorNetFunctions {
    ...
    pub(crate) network_set_optimizer_info: contraction::NetworkSetOptimizerInfoFn,
    ...
    pub(crate) optimizer_info_set_attribute: contraction::OptimizerInfoSetAttributeFn,
...
pub(crate) fn resolve_cutensornet_functions<R: SymbolResolver>(
    ...
    Ok(CuTensorNetFunctions {
        ...
        network_set_optimizer_info: resolve_required(
            resolver,
            CUTENSORNET_NAME,
            path,
            "cutensornetNetworkSetOptimizerInfo",
            b"cutensornetNetworkSetOptimizerInfo\0",
        )?,
        ...
        optimizer_info_set_attribute: resolve_required(
            resolver,
            CUTENSORNET_NAME,
            path,
            "cutensornetContractionOptimizerInfoSetAttribute",
            b"cutensornetContractionOptimizerInfoSetAttribute\0",
        )?,
