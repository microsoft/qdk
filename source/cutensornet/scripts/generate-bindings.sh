...
readonly FUNCTION_PATTERN='^(cutensornetGetVersion|cutensornetGetCudartVersion|cutensornetGetErrorString|cutensornetGetLastError|cutensornetCreate|cutensornetDestroy|cutensornetCreateState|cutensornetDestroyState|cutensornetStateApplyTensorOperator|cutensornetStateFinalizeMPS|cutensornetStateConfigure|cutensornetCreateWorkspaceDescriptor|cutensornetDestroyWorkspaceDescriptor|cutensornetStatePrepare|cutensornetWorkspaceGetMemorySize|cutensornetWorkspaceSetMemory|cutensornetStateCompute|cutensornetStateCaptureMPS|cutensornetCreateNetworkOperator|cutensornetNetworkOperatorAppendProduct|cutensornetDestroyNetworkOperator|cutensornetCreateExpectation|cutensornetExpectationConfigure|cutensornetExpectationPrepare|cutensornetExpectationCompute|cutensornetDestroyExpectation|cutensornetCreateSampler|cutensornetSamplerConfigure|cutensornetSamplerPrepare|cutensornetSamplerSample|cutensornetDestroySampler|cutensornetCreateNetwork|cutensornetDestroyNetwork|cutensornetNetworkAppendTensor|cutensornetNetworkSetOutputTensor|cutensornetNetworkSetAttribute|cutensornetCreateContractionOptimizerConfig|cutensornetDestroyContractionOptimizerConfig|cutensornetContractionOptimizerConfigSetAttribute|cutensornetCreateContractionOptimizerInfo|cutensornetDestroyContractionOptimizerInfo|cutensornetContractionOptimize|cutensornetContractionOptimizerInfoGetAttribute|cutensornetWorkspaceComputeContractionSizes|cutensornetNetworkPrepareContraction|cutensornetNetworkSetInputTensorMemory|cutensornetNetworkSetOutputTensorMemory|cutensornetNetworkContract|cutensornetCreateSliceGroupFromIDRange|cutensornetDestroySliceGroup)$'
readonly FUNCTION_NAMES='cutensornetContractionOptimize cutensornetContractionOptimizerConfigSetAttribute cutensornetContractionOptimizerInfoGetAttribute cutensornetCreate cutensornetCreateContractionOptimizerConfig cutensornetCreateContractionOptimizerInfo cutensornetCreateExpectation cutensornetCreateNetwork cutensornetCreateNetworkOperator cutensornetCreateSampler cutensornetCreateSliceGroupFromIDRange cutensornetCreateState cutensornetCreateWorkspaceDescriptor cutensornetDestroy cutensornetDestroyContractionOptimizerConfig cutensornetDestroyContractionOptimizerInfo cutensornetDestroyExpectation cutensornetDestroyNetwork cutensornetDestroyNetworkOperator cutensornetDestroySampler cutensornetDestroySliceGroup cutensornetDestroyState cutensornetDestroyWorkspaceDescriptor cutensornetExpectationCompute cutensornetExpectationConfigure cutensornetExpectationPrepare cutensornetGetCudartVersion cutensornetGetErrorString cutensornetGetLastError cutensornetGetVersion cutensornetNetworkAppendTensor cutensornetNetworkContract cutensornetNetworkOperatorAppendProduct cutensornetNetworkPrepareContraction cutensornetNetworkSetAttribute cutensornetNetworkSetInputTensorMemory cutensornetNetworkSetOutputTensor cutensornetNetworkSetOutputTensorMemory cutensornetSamplerConfigure cutensornetSamplerPrepare cutensornetSamplerSample cutensornetStateApplyTensorOperator cutensornetStateCaptureMPS cutensornetStateCompute cutensornetStateConfigure cutensornetStateFinalizeMPS cutensornetStatePrepare cutensornetWorkspaceComputeContractionSizes cutensornetWorkspaceGetMemorySize cutensornetWorkspaceSetMemory'
