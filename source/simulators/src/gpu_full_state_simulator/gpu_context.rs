...
impl GpuContext {
    ...
    pub fn run_shots_sync(&mut self, shot_count: i32, seed: u32) -> Result<RunResults, String> {
        futures::executor::block_on(self.run_shots(shot_count, seed))
    }

    /// Run the program for the given number of shots
    #[allow(clippy::too_many_lines)]
    pub async fn run_shots(&mut self, shot_count: i32, seed: u32) -> Result<RunResults, String> {
